...
\begin{figure}[htpb]
 \begin{tabular}{cc}
\includegraphics[angle=0,scale=0.3]{imagens/cap2/projxy.png} & \includegraphics[angle=0,scale=0.4]{imagens/cap2/projecao.png} \\
(a) & (b) 
\end{tabular}
...
\begin{figure}[htpb]
 \begin{tabular}{cc}
\includegraphics[angle=0,scale=0.46]{imagens/cap2/isosurfr3r2.png} & \includegraphics[angle=0,scale=0.35]{imagens/cap2/isosurfr3r2_2.png} \\
(a) & (b) 
\end{tabular}
